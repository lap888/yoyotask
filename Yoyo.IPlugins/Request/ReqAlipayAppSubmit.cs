...
namespace Yoyo.IPlugins.Request
{
    ...
    /// 
    /// </summary>
    public class ReqAlipayAppSubmit : IAlipayRequest<AlipayResult<Response.RspAlipayAppSubmit>>
    {
        #region 公共请求参数
        /// <summary>
        /// 回跳地址
        ...
        /// </summary>
        public List<UtilDictionary> GoodsDetail { get; set; }
        ...
        public UtilDictionary GetParam()
        {
            ...
            Param.Add("goods_detail", this.GoodsDetail);
